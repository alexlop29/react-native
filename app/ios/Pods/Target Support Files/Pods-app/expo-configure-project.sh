...
with_node \
  ...
  --platform "apple" \
  --packages "expo-application" "expo-asset" "expo-constants" "expo-device" "expo-file-system" "expo-font" "expo-keep-awake" "expo-router" "expo-system-ui" "expo-web-browser"
