...
with_node \
  ...
  --target "/Users/alexanderlopez/Desktop/Github/react-native/app/ios/Pods/Target Support Files/Pods-app/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "@react-native-google-signin/google-signin" "expo-asset" "expo-constants" "expo-file-system" "expo-font" "expo-keep-awake" "expo-router" "expo-system-ui" "expo-web-browser"
